        ...
        while(Loop) {
            ...
            switch(this.myState) {
                ...
                case SuperchargedFollowersAIState.Attacking:
                    ...
                    if (follower.TargetObject == null)
                    {
                        Plugin.Log.LogInfo("[STATE: " + this.myState + "]" + followerData.Brain.Info.Name + " precheck: lost enemy, reset to search");
                        this.myState = SuperchargedFollowersAIState.Searching;
                        break;
                    }
                    ...
                    while (attacking)
                    {
                        try {
                            ...
                            Plugin.Log.LogInfo("[STATE: " + this.myState + "]" + followerData.Brain.Info.Name + " hard reset to idle due to something went wrong when attacking at state [" + follower.state.CURRENT_STATE + "]: " + e.Message);
                            this.myState = SuperchargedFollowersAIState.Searching;
                            attacking = false;
                            break;
                        }
